...
select e.*, d.* from employees as e, departments as d where e.department = d.code;
-- 2.11 Select the name and last name of each employee, along with the name and budget of the employee's department.
select e.name,e.lastname, d.name, d.budget from employees as e, departments as d where e.department = d.code;
-- 2.12 Select the name and last name of employees working for departments with a budget greater than $60,000.
select e.name,e.lastname, d.name, d.budget from employees as e, departments as d where (e.department = d.code and d.budget>60000);
